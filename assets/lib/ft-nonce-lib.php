...
define( 'FT_NONCE_UNIQUE_KEY' , 'simply_contact_form_secret_str' );
define( 'FT_NONCE_DURATION' , 3600 ); // 300 makes link or form good for 5 minutes from time of generation, 3600 = 1 hour
